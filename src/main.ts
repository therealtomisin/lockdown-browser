...
//   if (isUrlAllowed(url) && mainWindow) {
...
//     if (sessionEndTimeout !== null) {
//       setTimeout(() => {
//         if (mainWindow && !mainWindow.isFocused() && sessionEndTimeout !== null) {
//           mainWindow.focus();
//           mainWindow.setFullScreen(true);
//         }
//       }, 100);
...
//   // Prevent navigation to non-whitelisted sites
//   mainWindow.webContents.on("will-navigate", (event, navigationUrl) => {
//     if (!navigationUrl.startsWith("file://") && !isUrlAllowed(navigationUrl)) {
//       event.preventDefault();
